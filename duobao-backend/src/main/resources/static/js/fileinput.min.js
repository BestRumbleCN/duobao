...
!function(e) {
    ...
    o = {
        ...
        init: function(e) {
            var i = e.initialPreview
              , t = e.id;
            i.length > 0 && !X(i) && (i = i.split(e.initialPreviewDelimiter)),
            o.data[t] = {
                content: i,
        ...
        get: function(i, t, a) {
            ...
            null === s.content[t] ? "" : (K(d) || K(d.frameClass) || (p += " " + d.frameClass),
            ...
            s.tags.length && s.tags[t] && (r = ee(r, s.tags[t])),
            K(d) || K(d.frameAttr) || (n = e(document.createElement("div")).html(r),
            n.find(".file-preview-initial").attr(d.frameAttr),
            r = n.html(),
            n.remove()),
            r)
        },
        add: function(i, t, a, r, n) {
            ...
            return X(t) || (t = t.split(s.delimiter)),
            n ? (l = s.content.push(t) - 1,
            s.config[l] = a,
            s.tags[l] = r) : (l = t.length,
            s.content = t,
            s.config = a,
            s.tags = r),
            o.data[i] = s,
        ...
        set: function(i, t, a, r, n) {
            ...
            if (t && t.length && (X(t) || (t = t.split(d.delimiter)),
            s = t.filter(function(e) {
                return null !== e
            }),
            s.length)) {
                if (void 0 === d.content && (d.content = []),
                void 0 === d.config && (d.config = []),
                void 0 === d.tags && (d.tags = []),
                n) {
                    for (l = 0; l < t.length; l++)
                        t[l] && d.content.push(t[l]);
                    for (l = 0; l < a.length; l++)
                        a[l] && d.config.push(a[l]);
        ...
        unset: function(e, i) {
            ...
            if (t) {
                if (1 === t)
                    return o.data[e].content = [],
                    void (o.data[e].config = []);
                o.data[e].content[i] = null ,
                o.data[e].config[i] = null
            }
        },
        out: function(e) {
        ...
        footer: function(e, i, t) {
            var a = o.data[e];
            if (t = void 0 === t ? !0 : t,
            0 === a.config.length || K(a.config[i]))
                return "";
            var r = a.config[i]
    ...
    F = '<div tabindex="500" class="{css}" {status}>{icon}{label}</div>',
    E = '<div id="{id}" class="file-preview-detail-modal modal fade" tabindex="-1">\n  <div class="modal-dialog modal-lg">\n    <div class="modal-content">\n      <div class="modal-header">\n        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>\n        <h3 class="modal-title">{heading} <small>{title}</small></h3>\n      </div>\n      <div class="modal-body">\n           <pre>{body}</pre>\n      </div>\n    </div>\n  </div>\n</div>',
    ...
    H = ["image", "html", "text", "video", "audio", "flash", "object"],
    W = {
        image: {
            width: "auto",
            height: "160px"
    ...
    q = function(i, t) {
        var a = this;
        a.$element = e(i),
        a._validate() && (a.isPreviewable = d(),
        a.isIE9 = r(9),
        a.isIE10 = r(10),
        a.isPreviewable || a.isIE9 ? (a._init(t),
        a._listen()) : a.$element.removeClass("file-loading"))
    }
    ,
    q.prototype = {
        constructor: q,
        _init: function(i) {
            ...
            K(a.allowedPreviewTypes) && (a.allowedPreviewTypes = H),
            a.fileInputCleared = !1,
            a.fileBatchCompleted = !0,
            a.isPreviewable || (a.showPreview = !1),
            a.uploadFileAttr = K(r.attr("name")) ? "file_data" : r.attr("name"),
            a.reader = null ,
            a.formdata = {},
            a.clearStack(),
            a.uploadCount = 0,
            ...
            a.imageCanvasContext = a.imageCanvas.getContext("2d")),
            K(a.$element.attr("id")) && a.$element.attr("id", Y()),
            ...
            a.$captionContainer = Q(i, "elCaptionContainer", a.$container.find(".file-caption")),
            a.$caption = Q(i, "elCaptionText", a.$container.find(".file-caption-name")),
            a.$previewContainer = Q(i, "elPreviewContainer", a.$container.find(".file-preview")),
            ...
            K(a.msgErrorClass) || u(a.$errorContainer, a.msgErrorClass),
            a.$errorContainer.hide(),
            a.fileActionSettings = e.extend(!0, m, i.fileActionSettings),
            a.previewInitId = "preview-" + Y(),
            a.id = a.$element.attr("id"),
            o.init(a),
            a._initPreview(!0),
            a._initPreviewDeletes(),
            a.options = i,
        ...
        _addError: function(e) {
            var i = this
              , t = i.$errorContainer;
            e && t.length && (t.html(i.errorCloseButton + e),
            l(t.find(".kv-error-close"), "click", function() {
                t.fadeOut("slow")
            }))
        },
        ...
        _showFolderError: function(e) {
            ...
            e && (i = t.msgFoldersNotAllowed.replace(/\{n}/g, e),
            t._addError(i),
            u(t.$container, "has-error"),
            a.fadeIn(800),
            t._raise("filefoldererror", [e, i]))
        },
        ...
        _noFilesError: function(e) {
            ...
            i._addError(a),
            i.isError = !0,
            i._updateFileDetails(0),
            r.fadeIn(800),
            i._raise("fileerror", [e, a]),
            i._clearFileInput(),
            u(i.$container, "has-error")
        },
        ...
        _parseFileType: function(e) {
            ...
            for (r = 0; r < H.length; r += 1)
                if (a = H[r],
                i = J(a, n.fileTypeSettings) ? n.fileTypeSettings[a] : V[a],
                t = i(e.type, e.name) ? a : "",
                !K(t))
                    return t;
            return "other"
        ...
        _parseFilePreviewIcon: function(i, t) {
            ...
            return t && t.indexOf(".") > -1 && (a = t.split(".").pop(),
            r.previewFileIconSettings && r.previewFileIconSettings[a] && (n = r.previewFileIconSettings[a]),
        ...
        _raise: function(i, t) {
            var a = this
              , r = e.Event(i);
            if (void 0 !== t ? a.$element.trigger(r, t) : a.$element.trigger(r),
        ...
        _listen: function() {
            var i = this
              ...
              , a = t.closest("form")
              , r = i.$container;
            l(t, "change", e.proxy(i._change, i)),
            l(i.$btnFile, "click", e.proxy(i._browse, i)),
            l(a, "reset", e.proxy(i.reset, i)),
            l(r.find(".fileinput-remove:not([disabled])"), "click", e.proxy(i.clear, i)),
            l(r.find(".fileinput-cancel"), "click", e.proxy(i.cancel, i)),
            i._initDragDrop(),
            i.isUploadable || l(a, "submit", e.proxy(i._submitForm, i)),
            l(i.$container.find(".fileinput-upload"), "click", e.proxy(i._uploadClick, i))
        },
        _initDragDrop: function() {
            var i = this
              , t = i.$dropZone;
            i.isUploadable && i.dropZoneEnabled && i.showPreview && (l(t, "dragenter dragover", e.proxy(i._zoneDragEnter, i)),
            l(t, "dragleave", e.proxy(i._zoneDragLeave, i)),
            l(t, "drop", e.proxy(i._zoneDrop, i)),
        ...
        _zoneDragEnter: function(i) {
            ...
            return t._zoneDragDropInit(i),
            t.isDisabled || !a ? (i.originalEvent.dataTransfer.effectAllowed = "none",
        ...
        _zoneDrop: function(e) {
            var i = this;
            e.preventDefault(),
            i.isDisabled || K(e.originalEvent.dataTransfer.files) || (i._change(e, "dragdrop"),
        ...
        _uploadClick: function(e) {
            ...
            if (!e || !e.isDefaultPrevented()) {
                if (!t.isUploadable)
                    return void (r && "submit" !== a.attr("type") && (i = a.closest("form"),
        ...
        _initPreview: function(e) {
            ...
            return o.count(t.id) ? (i = o.out(t.id),
            a = e && t.initialCaption ? t.initialCaption : i.caption,
            t.$preview.html(i.content),
            t._setCaption(a),
            void (K(i.content) || t.$container.removeClass("file-input-new"))) : (t._clearPreview(),
        ...
        _initPreviewDeletes: function() {
            var i = this
              ...
              , a = function() {
                ...
                0 !== i.$preview.find(".kv-file-remove").length || e || (i.reset(),
                i.initialCaption = "")
            }
            ;
            i.$preview.find(".kv-file-remove").each(function() {
                ...
                if (!K(n) && void 0 !== s) {
                    ...
                    p = K(g.config) && K(g.config[m]) ? null : g.config[m],
                    f = K(p) || K(p.extra) ? t : p.extra,
                    ...
                    d = e.extend(!0, {}, {
                        ...
                        beforeSend: function(e) {
                            i.ajaxAborted = !1,
                            i._raise("filepredelete", [s, e, f]),
                            i.ajaxAborted ? e.abort() : (u(v, "file-uploading"),
                            u(r, "disabled"))
                        },
                        success: function(e, t, n) {
                            var l, d;
                            return K(e) || K(e.error) ? (o.unset(i.id, m),
                            l = o.count(i.id),
                            d = l > 0 ? i._getMsgSelected(l) : "",
                            i._raise("filedeleted", [s, n, f]),
                            i._setCaption(d),
                            ...
                            void v.fadeOut("slow", function() {
                                ...
                                v.remove(),
                                a(),
                                l || 0 !== i.getFileStack().length || (i._setCaption(""),
                                i.reset())
                            })) : (c.jqXHR = n,
                            c.response = e,
                            i._showError(e.error, c, "filedeleteerror"),
                        ...
                        error: function(e, t, r) {
                            ...
                            c.jqXHR = e,
                            c.response = {},
                            i._showError(n, c, "filedeleteerror"),
                            v.removeClass("file-uploading"),
                            a()
                        }
        ...
        _clearFileInput: function() {
            ...
            K(n.val()) || (r.isIE9 || r.isIE10 ? (i = n.closest("form"),
        ...
        _resetPreviewThumbs: function(e) {
            var i, t = this;
            return e ? (t._clearPreview(),
            void t.clearStack()) : void (t._hasInitialPreview() ? (i = o.out(t.id),
            t.$preview.html(i.content),
            t._setCaption(i.caption),
            t._initPreviewDeletes()) : t._clearPreview())
        },
        ...
        _initXhr: function(e, i, t) {
            ...
            return e.upload && e.upload.addEventListener("progress", function(e) {
                ...
                i ? a._setAsyncUploadStatus(i, r, t) : a._setProgress(Math.ceil(r))
            }, !1),
            e
        },
        _ajaxSubmit: function(i, t, a, r, n, l) {
            var o, s = this;
            s._raise("filepreajax", [n, l]),
            s._uploadExtra(n, l),
            o = e.extend(!0, {}, {
                xhr: function() {
        ...
        _initUploadSuccess: function(i, t, a) {
            ...
            void 0 !== t ? a ? (u = t.attr("data-fileindex"),
            f.uploadCache.content[u] = d[0],
            f.uploadCache.config[u] = c[0],
            f.uploadCache.tags[u] = p[0],
            f.uploadCache.append = r) : (l = o.add(f.id, d, c[0], p[0], r),
            n = o.get(f.id, l, !1),
            s = e(n).hide(),
        ...
        _checkAsyncComplete: function() {
            ...
            for (t = 0; t < a.filestack.length; t++)
                if (a.filestack[t] && (i = a.previewInitId + "-" + t,
                -1 === e.inArray(i, a.uploadLog)))
                    return !1;
        ...
        _uploadSingle: function(i, t, a) {
            ...
            m.formdata = w,
            m.showPreview && (n = e("#" + _ + ":not(.file-preview-initial)"),
            s = n.find(".kv-file-upload"),
            d = n.find(".kv-file-remove"),
            e("#" + _).find(".file-thumb-progress").removeClass("hide")),
            ...
            l = function() {
                m.fileBatchCompleted && setTimeout(function() {
                    ...
                    m.hasInitData && (m._initPreview(),
                    m._initPreviewDeletes())),
                    m.unlock(),
                    m._clearFileInput(),
                    m._raise("filebatchuploadcomplete", [m.filestack, m._getExtraData()]),
                    m.uploadCount = 0,
                    m.uploadStatus = {},
                    m.uploadLog = [],
                    m._setProgress(100)
            ...
            c = function(t) {
                ...
                m.showPreview && (n.hasClass("file-preview-success") || (m._setThumbStatus(n, "Loading"),
                u(n, "file-uploading")),
                s.attr("disabled", !0),
                d.attr("disabled", !0)),
                a || m.lock(),
                m._raise("filepreupload", [r, _, i]),
                e.extend(!0, C, r),
                m._abort(C) && (t.abort(),
            ...
            p = function(t, l, o) {
                ...
                e.extend(!0, C, r),
                setTimeout(function() {
                    K(t) || K(t.error) ? (m.showPreview && (m._setThumbStatus(n, "Success"),
                    s.hide(),
                    m._initUploadSuccess(t, n, a)),
                    m._raise("fileuploaded", [r, _, i]),
                    a ? g(i, _) : m.updateStack(i, void 0)) : (m._showUploadError(t.error, C),
                    m._setPreviewError(n, i),
                    a && g(i, _))
                }, 100)
            }
            ,
            f = function() {
                setTimeout(function() {
                    m.showPreview && (s.removeAttr("disabled"),
            ...
            v = function(r, l, o) {
                ...
                setTimeout(function() {
                    a && g(i, _),
                    m.uploadStatus[_] = 100,
                    m._setPreviewError(n, i),
                    e.extend(!0, C, m._getOutData(r)),
                    m._showUploadError(s, C)
                }, 100)
            }
            ,
            w.append(m.uploadFileAttr, t[i], m.filenames[i]),
            w.append("file_id", i),
            m._ajaxSubmit(c, p, f, v, _, i))
        },
        _uploadBatch: function() {
            ...
            t = function(i, t, a) {
                ...
                K(i) || K(i.error) ? (l._raise("filebatchuploadsuccess", [r]),
                n(),
                l.showPreview ? (o.each(function() {
                    var i = e(this)
                      , t = i.find(".kv-file-upload");
            ...
            a = function(i, t, a) {
                var r = l._getOutData(i)
                  , n = l._parseError(i, a);
                l._showUploadError(n, r, "filebatchuploaderror"),
        ...
        _uploadExtraOnly: function() {
            ...
            i = function(e, i, t) {
                ...
                K(e) || K(e.error) ? (r._raise("filebatchuploadsuccess", [a]),
                r._clearFileInput(),
        ...
        _initFileActions: function() {
            ...
            i.showPreview && (i.$preview.find(".kv-file-remove").each(function() {
                ...
                l(s, "click", function() {
                    return n = i._raise("filepreremove", [c, p]),
                    n !== !1 && i._validateMinCount() ? (t = d.hasClass("file-preview-error"),
                    ie(d),
                    void d.fadeOut("slow", function() {
                        i.updateStack(p, void 0),
                        i._clearObjects(d),
                        d.remove(),
                        c && t && i.$errorContainer.find('li[data-file-id="' + c + '"]').fadeOut("fast", function() {
                            e(this).remove(),
                        ...
                        i._clearFileInput(),
                        0 !== l || 0 !== s || u ? (a = s + l,
                        r = a > 1 ? i._getMsgSelected(a) : n[0] ? i._getFileNames()[0] : "",
                        i._setCaption(r)) : i.reset(),
        ...
        _previewFile: function(e, i, t, a, r) {
            if (this.showPreview) {
                ...
                g || h ? (v = s._parseFilePreviewIcon(v, c.split(".").pop()),
                "text" === d ? (l = G(t.target.result),
                o = "text-" + Y(),
                n = v.replace(/\{zoom}/g, s._getLayoutTemplate("zoom")),
                _ = s._getLayoutTemplate("modal").replace("{id}", o).replace(/\{title}/g, p).replace(/\{body}/g, l).replace(/\{heading}/g, s.msgZoomModalHeading),
                ...
                s.$preview.append("\n" + n),
                s._validateImage(e, a, p, i.type)) : s._previewDefault(i, a)
            }
        },
        ...
        _readFiles: function(i) {
            ...
            var r, n = this, l = n.$element, o = n.$preview, s = n.reader, d = n.$previewContainer, c = n.$previewStatus, p = n.msgLoading, u = n.msgProgress, f = n.previewInitId, v = i.length, g = n.fileTypeSettings, m = n.filestack.length, h = function(t, a, l, o) {
                ...
                return n._previewDefault(a, l, !0),
                n.isUploadable && n.addToStack(void 0),
                setTimeout(r(o + 1), 100),
                n._initFileActions(),
                n.removeFromPreviewOnError && e("#" + l).remove(),
                n.isUploadable ? n._showUploadError(t, s) : n._showError(t, d)
            }
            ;
            n.loadedImages = [],
            ...
            r = function(e) {
                if (K(l.attr("multiple")) && (v = 1),
                e >= v)
                    return n.isUploadable && n.filestack.length > 0 ? n._raise("filebatchselected", [n.getFileStack()]) : n._raise("filebatchselected", [i]),
                ...
                if (K(A) || (k = new RegExp("\\.(" + A.join("|") + ")$","i")),
                $ = $.toFixed(2),
                n.maxFileSize > 0 && $ > n.maxFileSize)
                    return C = n.msgSizeTooLarge.replace("{name}", I).replace("{size}", $).replace("{maxSize}", n.maxFileSize),
                    void (n.isError = h(C, E, F, e));
                if (!K(D) && X(D)) {
                    for (b = 0; b < D.length; b += 1)
                        x = D[b],
                        _ = g[x],
                        y = void 0 !== _ && _(E.type, I),
                        S += K(y) ? 0 : y.length;
                    if (0 === S)
                        return C = n.msgInvalidFileType.replace("{name}", I).replace("{types}", U),
                        void (n.isError = h(C, E, F, e))
                }
                return 0 !== S || K(A) || !X(A) || K(k) || (y = a(I, k),
                S += K(y) ? 0 : y.length,
                ...
                s.onloadend = function() {
                    ...
                    setTimeout(function() {
                        c.html(C),
                        n._updateFileDetails(v),
                        r(e + 1)
                    }, 100),
                    n._raise("fileloaded", [E, F, e, s])
                }
                ,
                ...
                ,
                w = J("text", g) ? g.text : V.text,
                w(E.type, I) ? s.readAsText(E, n.textEncoding) : s.readAsArrayBuffer(E)) : (n._previewDefault(E, F),
                setTimeout(function() {
                    r(e + 1),
                    n._updateFileDetails(v)
                }, 100),
                n._raise("fileloaded", [E, F, e, s])),
                void n.addToStack(E)) : (n.addToStack(E),
                setTimeout(r(e + 1), 100),
                void n._raise("fileloaded", [E, F, e, s])) : (C = n.msgInvalidFileExtension.replace("{name}", I).replace("{extensions}", j),
                void (n.isError = h(C, E, F, e)))
            }
            ,
            r(0),
            n._updateFileDetails(v, !1)
        },
        _updateFileDetails: function(e) {
            ...
            i.$captionContainer.find(".kv-caption-icon").hide()) : i._showFileIcon(),
            i._setCaption(d, i.isError),
            i.$container.removeClass("file-input-new file-input-ajax-new"),
            1 === arguments.length && i._raise("fileselect", [e, n]),
        ...
        _setProgress: function(e, i, t) {
            ...
            i = i || a.$progress,
            K(n) || (i.html(n.replace(/\{percent}/g, r)),
            t && i.find('[role="progressbar"]').html(t))
        },
        _setFileDropZoneTitle: function() {
            var e = this
              , i = e.$container.find(".file-drop-zone");
            i.find("." + e.dropZoneTitleClass).remove(),
            e.isUploadable && e.showPreview && 0 !== i.length && !(e.getFileStack().length > 0) && e.dropZoneEnabled && (0 === i.find(".file-preview-frame").length && K(e.defaultPreviewContent) && i.prepend('<div class="' + e.dropZoneTitleClass + '">' + e.dropZoneTitle + "</div>"),
            e.$container.removeClass("file-input-new"),
            u(e.$container, "file-input-ajax-new"))
        },
        _setAsyncUploadStatus: function(i, t, a) {
            var r = this
              , n = 0;
            r._setProgress(t, e("#" + i).find(".file-thumb-progress")),
            r.uploadStatus[i] = t,
        ...
        _getFileCount: function(e) {
            var i = this
              , t = 0;
            return i.validateInitialCount && !i.overwriteInitial && (t = o.count(i.id),
            e += t),
            e
        },
        ...
        _checkDimensions: function(e, i, t, a, r, n, l) {
            ...
            c = "Small" === i ? s >= f : f >= s,
            c || (o = p["msgImage" + n + i].replace("{name}", r).replace("{size}", f),
            p._showUploadError(o, l),
            p._setPreviewError(a, e, null )))
        },
        _validateImage: function(e, i, a, r) {
            var n, o, s, d = this, c = d.$preview, p = c.find("#" + i), u = p.find("img");
            a = a || "Untitled",
            u.length && l(u, "load", function() {
                o = p.width(),
                s = c.width(),
                o > s && (u.css("width", "100%"),
                p.css("width", "97%")),
                ...
                d._checkDimensions(e, "Small", u, p, a, "Width", n),
                d._checkDimensions(e, "Small", u, p, a, "Height", n),
                d.resizeImage || (d._checkDimensions(e, "Large", u, p, a, "Width", n),
                d._checkDimensions(e, "Large", u, p, a, "Height", n)),
                d._raise("fileimageloaded", [i]),
                d.loadedImages.push({
                    ind: e,
                    img: u,
                    thumb: p,
                ...
                d._validateAllImages(),
                t.revokeObjectURL(u.attr("src"))
            })
        },
        _validateAllImages: function() {
            ...
            o.resizeImage)) {
                for (l = o.isUploadable ? o._showUploadError : o._showError,
                e = 0; e < o.loadedImages.length; e++)
                    i = o.loadedImages[e],
                    t = i.img,
                    a = i.thumb,
                    r = i.pid,
        ...
        _initCaption: function() {
            var e = this
              , i = e.initialCaption || "";
            return e.overwriteInitial || K(i) ? (e.$caption.html(""),
            !1) : (e._setCaption(i),
            !0)
        },
        _setCaption: function(i, t) {
            ...
            if (o.$caption.length) {
                if (t)
                    ...
                    n = s.length,
                    l = n ? 1 === n && s[0] ? o._getFileNames()[0] : o._getMsgSelected(n) : o._getMsgSelected(o.msgNo),
                    r = '<span class="' + o.msgValidationErrorClass + '">' + o.msgValidationErrorIcon + (K(i) ? l : i) + "</span>";
                else {
                    if (K(i))
                        return;
                    a = e("<div>" + i + "</div>").text(),
                    r = o._getLayoutTemplate("icon") + a
                }
                o.$caption.html(r),
        ...
        _renderButton: function(e) {
            ...
            K(l) || (l = ' <span class="' + i.buttonLabelClass + '">' + l + "</span>"),
        ...
        _browse: function(e) {
            var i = this;
            i._raise("filebrowse"),
            e && e.isDefaultPrevented() || (i.isError && !i.isUploadable && i.clear(),
            i.$captionContainer.focus())
        },
        _change: function(i) {
            var t = this
              , a = t.$element;
            if (!t.isUploadable && K(a.val()) && t.fileInputCleared)
            ...
            t._resetUpload(),
            t._hideFileIcon(),
            t.isUploadable && t.$container.find(".file-drop-zone ." + t.dropZoneTitleClass).remove(),
            p)
                for (r = []; v[f]; )
                    s = v[f],
                    s.type || s.size % 4096 !== 0 ? r.push(s) : w++,
                    f++;
            else
            ...
            if (K(r) || 0 === r.length)
                return u || t.clear(),
                t._showFolderError(w),
                void t._raise("fileselectnone");
            if (t._resetErrors(),
            c = r.length,
            l = t._getFileCount(t.isUploadable ? t.getFileStack().length + c : c),
            t.maxFileCount > 0 && l > t.maxFileCount) {
                if (!t.autoReplace || c > t.maxFileCount)
                    return d = t.autoReplace && c > t.maxFileCount ? c : l,
                    n = t.msgFilesTooMany.replace("{m}", t.maxFileCount).replace("{n}", d),
                    t.isError = _(n, null , null , null ),
                ...
                !u || h ? (t._resetPreviewThumbs(!1),
                h && t.clearStack()) : !u || 0 !== g || o.count(t.id) && !t.overwriteInitial || t._resetPreviewThumbs(!0);
            t.isPreviewable ? t._readFiles(r) : t._updateFileDetails(1),
            t._showFolderError(w)
        },
        _abort: function(i) {
            var t, a = this;
        ...
        lock: function() {
            ...
            e.disable(),
            e.showRemove && u(e.$container.find(".fileinput-remove"), "hide"),
        ...
        unlock: function(e) {
            ...
            return void 0 === e && (e = !0),
            i.enable(),
            i.showCancel && u(i.$container.find(".fileinput-cancel"), "hide"),
        ...
        clear: function() {
            ...
            t._resetPreview(),
            t._initPreviewDeletes(),
            t.$container.removeClass("file-input-new")) : (t._getThumbs().each(function() {
                t._clearObjects(e(this))
            }),
            t.isUploadable && (o.data[t.id] = {}),
            t.$preview.html(""),
            i = !t.overwriteInitial && t.initialCaption.length > 0 ? t.initialCaption : "",
            t._setCaption(i),
            t.$caption.attr("title", ""),
            u(t.$container, "file-input-new"),
            t._validateDefaultPreview()),
            0 === t.$container.find(".file-preview-frame").length && (t._initCaption() || t.$captionContainer.find(".kv-caption-icon").hide()),
            t._hideFileIcon(),
        ...
        upload: function() {
            ...
            if (r.minFileCount > 0 && r._getFileCount(n) < r.minFileCount)
                return void r._noFilesError(l);
            if (r.isUploadable && !r.isDisabled && (0 !== n || o)) {
                ...
                for (i = 0; a > i; i++)
                    void 0 !== r.filestack[i] && r._uploadSingle(i, r.filestack, !0)
            }
        },
        destroy: function() {
            var e = this
              , t = e.$container;
            return t.find(".file-drop-zone").off(),
            e.$element.insertBefore(t).off(i).removeData(),
            t.off().remove(),
            e.$element
        },
        refresh: function(i) {
            var t = this
              , a = t.$element;
            return i = i ? e.extend(!0, {}, t.options, i) : t.options,
            t.destroy(),
            a.fileinput(i),
    ...
    e.fn.fileinput = function(i) {
        if (d() || r(9)) {
            ...
            this.each(function() {
                ...
                l = new q(this,r),
                n.data("fileinput", l)),
                "string" == typeof i && a.push(l[i].apply(l, t))
            }),
            a.length) {
            case 0:
                return this;
